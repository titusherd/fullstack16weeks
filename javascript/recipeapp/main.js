...
const API_ENDPOINT = "https://v1.appbackend.io/v1/rows/8x2pSjxO9vl2";
...
async function buildApp() {
  ...
  recipes.data.forEach((recipe) => {
    ...
    recipeImage.classList.add("object-cover", "rounded-lg", "w-full", "h-[300px]");
    ...
    recipeContainer.classList.add("bg-slate-100", "p-6", "rounded-xl", "space-y-4");
